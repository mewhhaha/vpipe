-- This file is generated by tools/generate-spirv/generate.py.  Do not edit.
...
opMemberName :: Word16
opMemberName = opcode "OpMemberName"

opExtension :: Word16
opExtension = opcode "OpExtension"

opExtInstImport :: Word16
opExtInstImport = opcode "OpExtInstImport"
...
opExecutionMode = opcode "OpExecutionMode"
...
opTypeVector :: Word16
opTypeVector = opcode "OpTypeVector"

opTypeMatrix :: Word16
opTypeMatrix = opcode "OpTypeMatrix"

opTypeArray :: Word16
opTypeArray = opcode "OpTypeArray"

opTypeRuntimeArray :: Word16
opTypeRuntimeArray = opcode "OpTypeRuntimeArray"

opTypeStruct :: Word16
opTypeStruct = opcode "OpTypeStruct"
...
opConstantComposite = opcode "OpConstantComposite"
...
opDecorate :: Word16
opDecorate = opcode "OpDecorate"

opMemberDecorate :: Word16
opMemberDecorate = opcode "OpMemberDecorate"
...
capabilityShader = enumerant "Capability" "Shader"

addressingModelLogical :: Word32
addressingModelLogical = enumerant "AddressingModel" "Logical"

memoryModelGLSL450 :: Word32
memoryModelGLSL450 = enumerant "MemoryModel" "GLSL450"

executionModelVertex :: Word32
executionModelVertex = enumerant "ExecutionModel" "Vertex"

executionModelFragment :: Word32
executionModelFragment = enumerant "ExecutionModel" "Fragment"

executionModelGLCompute :: Word32
executionModelGLCompute = enumerant "ExecutionModel" "GLCompute"

executionModeOriginUpperLeft :: Word32
executionModeOriginUpperLeft = enumerant "ExecutionMode" "OriginUpperLeft"

executionModeLocalSize :: Word32
executionModeLocalSize = enumerant "ExecutionMode" "LocalSize"

storageClassOutput :: Word32
storageClassOutput = enumerant "StorageClass" "Output"

decorationBlock :: Word32
decorationBlock = enumerant "Decoration" "Block"

decorationBuiltIn :: Word32
decorationBuiltIn = enumerant "Decoration" "BuiltIn"

decorationLocation :: Word32
decorationLocation = enumerant "Decoration" "Location"

decorationComponent :: Word32
decorationComponent = enumerant "Decoration" "Component"

decorationOffset :: Word32
decorationOffset = enumerant "Decoration" "Offset"

decorationArrayStride :: Word32
decorationArrayStride = enumerant "Decoration" "ArrayStride"

decorationMatrixStride :: Word32
decorationMatrixStride = enumerant "Decoration" "MatrixStride"

decorationColMajor :: Word32
decorationColMajor = enumerant "Decoration" "ColMajor"

decorationDescriptorSet :: Word32
decorationDescriptorSet = enumerant "Decoration" "DescriptorSet"

decorationBinding :: Word32
decorationBinding = enumerant "Decoration" "Binding"

builtInPosition :: Word32
builtInPosition = enumerant "BuiltIn" "Position"
